...
namespace Pos.Identity.Application.Interfaces.Services
{
    public interface IEmailService
    {
        ...
        Task ResendUserInvitationEmailAsync(string email,string fullName,string temporaryPassword,DateTime temporaryPasswordExpiresAt,string portalName,CancellationToken cancellationToken = default);
